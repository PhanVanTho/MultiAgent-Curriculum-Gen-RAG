...
1. SAFE: Normal academic or general knowledge topics (e.g., Mathematics, IT, Computer Science, Biology, History, Economics).
   Examples: "Vật lý hạt nhân", "Lịch sử Chiến tranh thế giới", "Kinh tế học", "Sinh học phân tử", "Mạng máy tính", "Lập trình web"
   IMPORTANT: ONLY use REFRAME or BLOCK if the topic involves explicitly dangerous, illegal, or highly sensitive subjects (weapons, drugs, hacking, crimes, self-harm). For all standard STEM or humanities subjects, you MUST output SAFE.
...
def reframe_topic(topic: str) -> str:
    ...
    """
    return f"{topic}: Phân tích chuyên sâu từ góc độ học thuật, nguyên lý và hệ quả"
