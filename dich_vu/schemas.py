                ...
                "sections": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "new_terms": {
                                "type": "array",
                                "description": "DANH SÁCH CÁC THUẬT NGỮ MỚI (CHUYÊN NGÀNH) được phát sinh trong bài mà CHƯA có trong CURRENT TERMS.",
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "term": {"type": "string", "description": "Tên thuật ngữ khoa học/chuyên ngành cốt lõi"},
                                        "meaning": {"type": "string", "description": "Giải nghĩa ngắn gọn, chính xác trong ngữ cảnh"}
                                    },
                        ...
                        "required": ["title", "content", "fact_mappings", "summary", "new_terms"],
                        "additionalProperties": False
                    }
                }
            },
                        ...
                        "properties": {
                            ...
                            "sections": {
                                ...
                                "items": {
                                    ...
                                    "required": ["title", "subsections", "recommended_pids"],
                                    "additionalProperties": False
                                }
                            }
                        },
